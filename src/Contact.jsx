...
function Contact() {
  ...
  return (
    <div className="mx-5 min-h-screen pt-32 sm:mx-[100px]">
      <section className="grid gap-12 pb-20 sm:grid-cols-[0.9fr_1.1fr] sm:items-start">
      <div>
        ...
        <div className="mt-8 grid gap-3">
          {contactLinks.map((link) => {
            ...
            return (
              <a
                className="group flex items-center gap-4 rounded-lg border border-black/10 p-4 transition-colors hover:bg-[#f7f7f5] dark:border-white/10 dark:hover:bg-white/10"
                href={link.href}
                key={link.label}
      ...
      <div className="rounded-lg border border-black/10 bg-[#f7f7f5] p-5 dark:border-white/10 dark:bg-white/5 sm:p-7">
        <div>
        ...
        <form className="mt-6 space-y-5" method="post" onSubmit={handleSubmit}>
          ...
          <button
            className="inline-flex w-full cursor-pointer items-center justify-center gap-2 rounded bg-black px-5 py-3 text-sm font-bold text-white transition-colors hover:bg-black/80 disabled:cursor-not-allowed disabled:opacity-60 dark:bg-white dark:text-black dark:hover:bg-white/80"
